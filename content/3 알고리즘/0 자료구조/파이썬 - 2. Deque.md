...
- 접근
	...
	- `de[n]` - $O(n)$
		- $O(n)$ in the middle. *For fast random access, use [[파이썬 - 1. List| lists]] instead*.

# Reference
- [collections — Container datatypes — Python 3.14.3 documentation](https://docs.python.org/3/library/collections.html#collections.deque)
- [Deque in Python - GeeksforGeeks](https://www.geeksforgeeks.org/python/deque-in-python/)